...
@Component({
  selector: 'web-page-product-hrpayroll',
  templateUrl: './page-product-hrpayroll.component.html',
  styleUrls: ['./page-product-hrpayroll.component.scss']
})

export class PageProductHrpayrollComponent extends BaseComponent
implements OnDestroy, OnInit{

  dynamicStateKey = makeStateKey<any>('hrProductInfo');
  dynamicStateConstentKey = makeStateKey<any>('constantData');
  dynamicDatabaseKey = 'hr-product-menu-data';
  dynamicPageData: any;
