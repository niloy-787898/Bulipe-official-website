...
@Component({
  selector: 'app-page-product-taskbing',
  templateUrl: './page-product-taskbing.component.html',
  styleUrls: ['./page-product-taskbing.component.scss']
})

export class PageProductTaskbingComponent extends BaseComponent
implements OnDestroy, OnInit{

  dynamicStateKey = makeStateKey<any>('smeProductInfo');
  dynamicStateConstentKey = makeStateKey<any>('constantData');
  dynamicDatabaseKey = 'tb-product-menu-data';
  dynamicPageData: any;
