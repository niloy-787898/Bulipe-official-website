...
@Component({
  selector: 'web-page-product-erp',
  templateUrl: './page-product-erp.component.html',
  styleUrls: ['./page-product-erp.component.scss']
})

export class PageProductErpComponent extends BaseComponent
implements OnDestroy, OnInit{

  dynamicStateKey = makeStateKey<any>('erpProductInfo');
  dynamicStateConstentKey = makeStateKey<any>('constantData');
  dynamicDatabaseKey = 'erp-product-menu-data';
  dynamicPageData: any;
